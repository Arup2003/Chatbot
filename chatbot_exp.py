...
answers.close()
                                               ...
                                               #  VERSION 1.01 #
#-----------------------------------This is experiment to for typing reply and identifying percentage similarity-------------------
#-----------------------------Replace input("Write\n") with takeCommand.lower() for voice))------------------------------
...
while Exit == True:
	...
	while start == "hello rabbit":
		...
		query = input("Write\n")   #lower() is used to keep all your queries in lowercase.
...
#FROM HERE STARTS KEYWORD FINDING
		...
		elif 'wikipedia' in query2 or 'wiki' in query2:
			speak('Do you want me to search' + query2)
			search_switch = input("Write\n")
			if search_switch == "yes":
